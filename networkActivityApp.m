    ...
    methods (Access = private)
        function createComponents(app)
            ...
            app.Figure = figure('Units', 'pixels', 'Visible', 'off',...
                'Position', [screenSize(3)/5 screenSize(4)/6 1700 850],...
            ...
            app.ButtonAnalysis = uibuttongroup(app.Figure, 'Units', 'pixels',...
                'Title', 'Detect spikes', 'Position', [1200 210 200 150], 'FontSize', 12, 'Enable', 'off');
            ...
            app.PushAnalysis = uicontrol(app.Figure, 'Style', 'pushbutton',...
                'String', 'Detect', 'Units', 'pixels', 'Position', [1200 160 100 30],...
            ...
            app.PushQuantify = uicontrol(app.Figure, 'Style', 'pushbutton',...
                'String', 'Quantify', 'Units', 'pixels', 'Position', [1300 160 100 30],...
                'FontSize', 12, 'Enable', 'off',...
